        ...
        try:
            ...
            while True:
                ...
                if self.is_locked:
                    ...
                    logger.debug(f'Timeout on aquiring lock {lock_id} on {lock_filename}')
                    raise Timeout(self._lock_file)
                else:
                    logger.debug(f'Lock {lock_id} not acquired on {lock_filename}, waiting {poll_interval} seconds ...')
